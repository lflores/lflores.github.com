...
var $httpBackend;
var factPersonal1, factPersonal2, factPersonal3, pmcEdenor, pmcVictoria, pmcHurlingham, factFibertel1, factFibertel2, pmcAysa, pmcOSDE, pmcGasNatural;
...
describe('text-discovery-service', function () {
    ...
    it('file discovery personal factura 1', function () {
        var response = textDiscovery.parseFile(factPersonal1);
        ...
        expect(response.amounts.length).toEqual(8);
    ...
    it('file discovery personal factura 2', function () {
        var response = textDiscovery.parseFile(factPersonal2);
        ...
        expect(response.amounts[0].amount).toEqual(66.51);
        expect(response.amounts[1].amount).toEqual(334.04);
        ...
        expect(response.amounts[0].text).toEqual("Cargos Fijos Abono Fijo 3 +i (14-05 - 13-06) 1 202,9300 21% 202,93 Protección GSM Médium Ind (14-05 - 13-06) # 1 63,8300 21% 63,83 Protección Medium Ind Exento (14-05 - 13-06) # 1 0,7700 0% 0,77 Crédito Promocional 1 46,0000 -46,00 21% 0,00 267,53 Impuestos IVA 21% 56,02 Imp. Internos Ley 25.239 4.1667% 8,46 Cargo ENARD Ley 26.573 1% 2,03 66,51");
        expect(response.amounts[1].text).toEqual("TOTAL FACTURA $ 334,04");
        expect(response.amounts[2].text).toEqual("Saldo Anterior 334,04 Pagos Realizados -334,04");
        expect(response.amounts[3].text).toEqual("Cargos del Mes 334,04");
        expect(response.amounts[4].text).toEqual("TOTAL A PAGAR $ 334,04");
        expect(response.amounts[5].text).toEqual("$ 334,04");
        expect(response.amounts[6].text).toEqual("TOTAL A PAGAR $ 334,04");
        expect(response.amounts[7].text).toEqual("$ 334,04");

        expect(response.name).toEqual("Personal");
    });

    it('file discovery personal factura 3', function () {
        var response = textDiscovery.parseFile(factPersonal3);
        //console.log(factPersonal1);
        expect(response.dates).not.toEqual(null);
        expect(response.dates.length).toEqual(7);
    ...
    it('file discovery Pago mis cuentas Edenor', function () {
        var response = textDiscovery.parseFile(pmcEdenor);
    ...
    it('file discovery Pago Mis Cuentas Victoria', function () {
        var response = textDiscovery.parseFile(pmcVictoria);
    ...
    it('file discovery Pago mis cuentas Hurlingham', function () {
        var response = textDiscovery.parseFile(pmcHurlingham);
        //console.log(pmcEdenor);
        expect(response.dates).not.toEqual(null);
        expect(response.dates.length).toEqual(1);
    ...
    it('file discovery Pago mis cuentas Aysa', function () {
        var response = textDiscovery.parseFile(pmcAysa);
        //console.log(pmcEdenor);
        expect(response.dates).not.toEqual(null);
    ...
    it('file discovery Pago mis cuentas OSDE', function () {
        var response = textDiscovery.parseFile(pmcOSDE);
        //console.log(pmcEdenor);
        expect(response.dates).not.toEqual(null);
        expect(response.dates.length).toEqual(1);
        expect(moment(response.dates[0].date).format("DD-MM-YYYY")).toEqual("05-01-2016");
    ...
    it('file discovery fibertel factura 1', function () {
        var response = textDiscovery.parseFile(factFibertel1);
        //console.log(factPersonal1);
        expect(response.dates).not.toEqual(null);
    ...
    it('file discovery fibertel factura 2', function () {
        var response = textDiscovery.parseFile(factFibertel2);
        //console.log(factPersonal1);
        expect(response.dates).not.toEqual(null);
        expect(response.dates.length).toEqual(11);
    ...
    it('file discovery Pago mis cuentas Gas Natural', function () {
        var response = textDiscovery.parseFile(pmcGasNatural);
        //console.log(pmcEdenor);
        expect(response.dates).not.toEqual(null);
        expect(response.dates.length).toEqual(1);
    ...
    it('file discovery test search personal origins', function () {
        var response = textDiscovery.origins("person");
        //console.log(pmcVictoria);
    ...
    it('file discovery test search hurlingham origins', function () {
        var response = textDiscovery.origins("hurli");
        //console.log(pmcVictoria);
        expect(response).not.toEqual(null);
        expect(response.length).toEqual(1);
